<%@ Page Title="" Language="C#" MasterPageFile="~/siteuser.master" AutoEventWireup="true" CodeFile="userpayment_receipt.aspx.cs" Inherits="userpaymentreceipt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="right1" Runat="Server">
    <div class="title_new">
            <div class="floatleft">
                <div class="td">
                   <asp:Label ID="lbtitle" runat="server" Text="Pay Bill"></asp:Label>
                </div>
             </div>
    ...
    <br />
        <span class="bold"><asp:Label ID="lbtitleid" runat="server" Text="Payment receipt"></asp:Label></span>
        <br /><br />
