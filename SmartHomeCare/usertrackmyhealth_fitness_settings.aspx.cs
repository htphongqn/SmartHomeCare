...
using System.Data;
public partial class usertrackmyhealth_fitness_settings : System.Web.UI.Page
{
    ...
    private void LoadInfo()
    {
        ...
        if (dr != null)
        {
            ...
            hplcustom.NavigateUrl = "usertrackmyhealth_fitness_settings_custom.aspx?Id=" + BaseView.GetStringFieldValue(dr, "FitnessId");
