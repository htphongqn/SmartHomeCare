        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="usertrackotherhealth.aspx"> Track <asp:Label ID="lbcurrentuser" runat="server" Text="my" runat="server"></asp:Label> health </a>  »<asp:LinkButton ID="lblinks" runat="server">Fertility monitoring</asp:LinkButton> » Settings
                    ...
                    <div class="row">
                        <div class="col-lg-6" style="width:100%;">
                            ...
                            <div class="clear" style="margin-bottom:20px;margin-top:20px">
                                 ...
                                 <asp:Button ID="btnback" runat="server" Text="Cancel" CausesValidation="false" PostBackUrl="usertrackothers_fertility.aspx" CssClass="btn btn-default"/>
                            </div>
                        </div>
                    </div>
                </div>
