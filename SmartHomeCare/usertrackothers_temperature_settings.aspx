                        ...
                        <div class="col-lg-6">
                             ...
                             <div class="clear borderbottom">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlSimpleRate" runat="server" Width="50px" CssClass="form-control" DataValueField = "AutoId" DataTextField = "Name" OnChange="javascript:enablebtn();"></asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td>Low Threshold:</td>
                                        <td>
                                        ...
                                        <td> 
                                            <asp:Label ID="lbNormalThresholdUnits" runat="server" Text="⁰F"></asp:Label>   </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                                <asp:Label ID="lbHighThresholdUnits" runat="server" Text="⁰F"></asp:Label></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="no-border" style="margin-bottom:10px;margin-top:10px">
                                ...
                                <asp:Button ID="btnback" runat="server" Text="Cancel"  CssClass="btn btn-default"
                                        PostBackUrl="~/usertrackothers_temperature.aspx" />
                            </div>                
                        </div>
                    </div>
                </div>
