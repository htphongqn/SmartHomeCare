                    ...
                    <div class="row">
                        <div class="col-lg-6" style="width:100%;">
                                ...
                                <asp:MultiView ID="MultiViewHeartRate" runat="server" ActiveViewIndex="0">        
                                    ...
                                    <div class="item_report">
                                        <div id="Div2">
                                                ...
                                                <asp:DropDownList ID="ddl_Graph" runat="server" CssClass="form-control" style="width:30%;display:inline;"
                                                        AutoPostBack="True">
                            ...
                            <div class="clear" style="margin-top: 10px;">
                                <asp:Button ID="Button1" runat="server" Text="Settings" PostBackUrl="~/usertrackothers_sleep_settings.aspx" CssClass="btn btn-default"/>
