...
<asp:Content ID="Content2" ContentPlaceHolderID="right1" Runat="Server">    
           <div class="title_new">
            <div class="floatleft">
                ...
                » <a href="usertrackothers_bodymeasurement.aspx"> Body measurement monitoring</a></div>
    ...
    <div class="no-border">
        ...
        <table class="clear" width="200" >
            <tr>
                <td>
                    <asp:Button ID="btnSetting" runat="server" Text="Settings" 
                        PostBackUrl="~/usertrackothers_bodymeasurement_settings.aspx" />
                </td>
                <td>
                    <asp:Button ID="Button2" runat="server" Text="Back to Track others health" 
