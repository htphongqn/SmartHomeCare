...
<asp:Content ID="Content2" ContentPlaceHolderID="right1" runat="Server">
        ...
        <asp:MultiView ID="MultiViewStress" runat="server" ActiveViewIndex="0">
                ...
                <div class="item_report">
                    <div id="chart">
                        ...
                        <div class="select_data">
                            ...
                            <asp:DropDownList ID="ddl_graph" runat="server" CssClass="dropdown" AutoPostBack="True"
            ...
            <asp:View ID="ViewTable" runat="server">
                <div class="item_report">
                    ...
                    <div class="select_data">
                        Report is viewed with:
                        <asp:DropDownList ID="ddl_Table" runat="server" CssClass="dropdown" AutoPostBack="True"
    ...
    <div class="clear">
        ...
        <table class="clear" width="200">
            <tr>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Settings" PostBackUrl="~/usertrackothers_stress_settings.aspx" />
                </td>
                <td>
