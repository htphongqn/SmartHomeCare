<%@ Page Title="" Language="C#" MasterPageFile="~/siteadmin.master" AutoEventWireup="true" CodeFile="admininbox.aspx.cs" Inherits="admininbox" %>
            ...
            if (Ids != "") {
                jConfirm('<%= DBClass.GetMessageByCode2("delete_message") %>', 'Question?', function (r) {
                    if (r) {
                        $.ajax({
                            type: "POST",
                            url: 'admininbox.aspx/DeleteMessage',
