<%@ Page Title="sleep monitoring setting" Language="C#" MasterPageFile="~/siteuser.master" AutoEventWireup="true" CodeFile="usertrackmyhealth_sleep_settings.aspx.cs" Inherits="usertrackmyhealth_sleep_settings" %>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <asp:LinkButton ID="btnLinks" runat="server" onclick="btnLinks_Click">Sleep monitoring</asp:LinkButton> » Settings
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtgsrsamplerate" runat="server" Width="133px" CssClass="form-control" onclick="javascript:enablebtn();"
                                                onkeypress="return digits(this, event, true, true);" ></asp:TextBox>
                                            <asp:DropDownList ID="ddlgsrsamplerate" runat="server" Width="80px" CssClass="form-control"  OnChange="javascript:enablebtn();"
                                                DataTextField="Name" DataValueField="AutoId"></asp:DropDownList> 
                                        </td>
                                    </tr>
                                    <tr>
