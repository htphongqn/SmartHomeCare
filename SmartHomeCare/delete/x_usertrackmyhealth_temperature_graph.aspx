<%@ Page Title="" Language="C#" MasterPageFile="~/siteuser.master" AutoEventWireup="true" CodeFile="x_usertrackmyhealth_temperature_graph.aspx.cs" Inherits="usertrackmyhealth_temperature_graph" %>
        ...
        <table class="clear" width="100">
            <tr>
                ...
                <td><asp:Button ID="btntable" runat="server" Text="Table" 
                        PostBackUrl="~/usertrackmyhealth_temperature_table.aspx" 
