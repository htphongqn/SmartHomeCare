                    ...
                    <div class="row">
                        <div class="col-lg-6" style="width:100%;">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>Sample rate:
                                            ...
                                            <asp:TextBox ID="txtsamplerate" runat="server" Width="103px" onclick="javascript:enablebtn();" CssClass="form-control"
                            ...
                            <div class="clear" style="margin-bottom:20px;margin-top:20px">
                                ...
                                <asp:Button ID="btnback" runat="server" Text="Cancel" CausesValidation="false" PostBackUrl="usertrackothers_position.aspx" CssClass="btn btn-default"/>
                            </div>
                        </div>
                    </div>
                </div>
