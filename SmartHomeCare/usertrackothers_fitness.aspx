                        ...
                        <div class="col-lg-6" style="width:100%;">
                                    ...
                                    <div class="item_report">
                                        <div id="chart" align="center">
                                                <div style="padding-top:5px;">
                                                    Select parameter to draw:<asp:DropDownList ID="ddlParameter" runat="server" CssClass="form-control" style="width:30%;display:inline;"
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-bottom:5px;">
                                                            <asp:TextBox ID="txtToDate" runat="server" Width="150"></asp:TextBox><asp:CalendarExtender ID="txtToDate_CalendarExtender"
                                        ...
                                        <asp:LinkButton ID="lbPopup" runat="server" CssClass="lbPopup" 
                                            ...
                                            runat="server" Visible="False">
                                                            ...
                                                            <div class="ContentDateTime">
                                                                ...
                                                                <td style="padding-bottom:5px;">
                                                                    <asp:TextBox ID="txtToDateTable" runat="server" Width="150"></asp:TextBox>
                                                                    <asp:CalendarExtender ID="clTo" runat="server" CssClass="orange" Enabled="True" TargetControlID="txtToDateTable">
                                                                    </asp:CalendarExtender>
                                                                </td>
                                                                </tr>
                                                                <tr align="center">
                            ...
                            <div class="no-border" style="margin-top: 10px;">
                                <asp:Button ID="Button1" runat="server" Text="Settings" CssClass="btn btn-default"
                                    PostBackUrl="~/usertrackothers_fitness_settings.aspx" />
