<%@ Page Title="Sent Message" Language="C#" MasterPageFile="~/siteuser.master" AutoEventWireup="true" CodeFile="usersentmessages.aspx.cs" Inherits="usersentmessages" %>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="clear">
                                ...
                                <input id="btnDelete" type="button" value="Delete" onclick="DeleteMessage()" CssClass="btn btn-default"/>
                            </div>
                            <br />
