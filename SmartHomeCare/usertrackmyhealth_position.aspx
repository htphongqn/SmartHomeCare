            ...
            <div class="floatleft">
                <div class="td">
                   <a href="usertrackmyhealth.aspx"> Track <asp:Label ID="lbNameHealth" runat="server" Text="my"></asp:Label> health </a> » 
                    <asp:LinkButton ID="lbLinks" runat="server" onclick="lbLinks_Click">Position monitoring</asp:LinkButton>
        ...
        <table class="clear" width="200">
            <tr>
                <td><asp:Button ID="Button1" runat="server" Text="Settings" 
                        PostBackUrl="~/usertrackmyhealth_position_settings.aspx"/></td>
