...
public partial class Steechart2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Steema.TeeChart.Chart ch1 = WebChart1.Chart;
        MemoryStream tmpChart = new MemoryStream();
        ch1.Chart.Tools.Add(new Steema.TeeChart.Tools.ScrollTool());
        ...
        if (Page.Cache["ch1Scroll"] == null)
        {
            ...
            ch1.Series[0].ScreenPointToValuePoint(100, 100);
            ch1.Series[0].Clear();
            ch1.Series[1].Clear();
